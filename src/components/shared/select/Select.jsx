...
export const Select = ({ control, name, styles, headerClassName, label, required, closeMenuOnSelect, className, isMulti, withInfo, fullWidth, options, setSelectedOption, defaultValue, placeholder }) => {
	return (
			<div className={`${className} ${s.selectGroup}`}>
